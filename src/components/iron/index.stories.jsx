...
stories
  ...
  .addWithJSX('iron-selector - custom prop for select', () => (
    <div>
      <IronSelector propForSelect="data-page" selected={text('selected', 'page-1')} onChange={action('changed')}>
        <div data-page="page-0"><p>0 - Lorem ipsum dolor sit amet, </p></div>
        <div data-page="page-1"><p>1 - Lorem ipsum dolor sit amet, </p></div>
        <div data-page="page-2"><p>2 - Lorem ipsum dolor sit amet, </p></div>
        <div data-page="page-3"><p>3- Lorem ipsum dolor sit amet, </p></div>
        <div data-page="page-4"><p>4 - Lorem ipsum dolor sit amet, </p></div>
        <div data-page="page-5"><p>5 - Lorem ipsum dolor sit amet, </p></div>
      </IronSelector>
      <style>
        {`
      .iron-selected{
